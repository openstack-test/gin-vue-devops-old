...
<<<<<<< HEAD
	{GVA_MODEL: global.GVA_MODEL{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "dashboard", Name: "dashboard", Hidden: false, Component: "view/dashboard/index.vue", Sort: 1, Meta: model.Meta{Title: "首页", Icon: "setting"}},
=======
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 15, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "2", Path: "k8sNamespaces", Name: "k8sNamespaces", Component: "view/kubernetes/namespaces/k8sNamespaces.vue", Sort: 1, Meta: model.Meta{Title: "命名空间管理", Icon: "menu"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 16, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "2", Path: "k8sDeployments", Name: "k8sDeployments", Component: "view/kubernetes/deployments/k8sDeployments.vue", Sort: 2, Meta: model.Meta{Title: "应用管理", Icon: "s-grid"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 17, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "2", Path: "k8sPods", Name: "k8sPods", Component: "view/kubernetes/pods/index.vue", Sort: 3, Meta: model.Meta{Title: "容器管理", Icon: "s-grid"}},
>>>>>>> develop
...
<<<<<<< HEAD
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 9, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "example", Name: "example", Component: "view/example/index.vue", Sort: 6, Meta: model.Meta{Title: "上传工具", Icon: "s-management"}},
