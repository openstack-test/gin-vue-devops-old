...
var BaseMenus = []model.SysBaseMenu{
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 2, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "kubernetes", Name: "kubernetes", Component: "view/kubernetes/table/k8sNamespaces.vue", Sort: 2, Meta: model.Meta{Title: "Kubernetes管理", Icon: "cloudy"}},
