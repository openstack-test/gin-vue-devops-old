  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">        
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增k8sDeployments表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="Kind资源" prop="deployment" width="120"></el-table-column> 
